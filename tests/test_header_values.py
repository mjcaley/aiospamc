...
@pytest.mark.parametrize("test_input,expected", [
    ...
    (SetOrRemoveValue(ActionOption(local=True, remote=False)), {"action": {"local": True, "remote": False}}),
    (MessageClassValue(value=MessageClassOption.ham), {"value": "ham"}),
    (SpamValue(value=True, score=1.0, threshold=10.0), {"value": True, "score": 1.0, "threshold": 10.0}),
